...
<p align="left"> Um eterno estudante de tecnologia movido a código e uma obsessão por arquiteturas limpas e sistemas eficientes. Unindo a base técnica do SENAI, a graduação em ADS e os desafios da Engenharia da Computação, sou fascinado por transformar café em softwares que realmente resolvem problemas. Já passei pela Porto Seguro, rodei pela Scania e hoje estou no Itaú. Quando não estou programando, estou provavelmente tentando descobrir por que o código funcionou de primeira (o que é sempre muito suspeito).</p>&nbsp;
